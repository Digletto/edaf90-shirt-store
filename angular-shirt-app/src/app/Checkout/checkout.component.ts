...
@Component({
  ...
  export class CheckoutComponent implements OnInit{
    ...
    exampleItem = new Shirt('M', 'red', '#000', 'surreptitious', 'Adjective', "kept secret especially because it would not be approved of", 1, "");
    exampleItem2 = new Shirt('XS', 'black', '#fff', 'verisimilitude', 'Noun', "the appearence of being true or real", 2, "");
